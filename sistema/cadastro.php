<?php
	...
	include "Config/config_sistema.php";
 	...
 	if($act == "cadastrar")
 	{
		...
		$sql = "insert into cadastro (idcadastro,login,senha,nome,email,bicho,bicho_data,bicho_hora) values ('','$login','$senha','$nome','$email','$bicho','$data_acesso','$hora_acesso')";
	...
	<form action="" method="post" enctype="multipart/form-data" name="formcadastro">
        ...
        <div class="form_square_yellow">
			...
			<label for="label4">E-mail</label>
 			...
 			<!---BICHINHO---->	 
			Bichinho:<input name="bicho" type="radio" value="1" id="radiobutton" checked="checked" />
			<label for="radiobutton"><span class="style6">Panda</span> 
		   	<input name="bicho" type="radio" value="2" id="radiobutton" />
           	<label for="radiobutton">Ursa</span><span class="style9"> *</span></label>
			</br>
