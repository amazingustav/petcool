...
if($lAtCo<>0)
{
	...
	if($Ho_Co >= '00:02')
	{
		...
		$Bt_Co = "on";
		$Msg_Co = "Sem Alimentação <br>há <b>".$Ho_Co_Prox." minuto(s)</b>";
	}
	else
	{
		$Ho_Co_Prox = funcoes::horaDif($Ho_Co,'00:02');
		$Bt_Co = "off";
		$Msg_Co = "Próxima Alimentação <br>em <b>".$Ho_Co_Prox." minuto(s)</b>";
	}
}
else
{
...
if($Ho_Co >= '00:27' or $Ho_Br >= '00:29' or $Ho_Ba >= '00:31')
{
	...
	$Bt_Re = "off";
	$Bt_Novo = "on";
	$Msg_Co = "<b>Seu Bichinho Faleceu!</b>";
	$Msg_Br = "<b>Seu Bichinho Faleceu!</b>";
	$Msg_Ba = "<b>Seu Bichinho Faleceu!</b>";
}
...
if($act == "novo"){
	...
	$sqlAlt = "update cadastro set bicho_data='$bicho_data',bicho_hora='$bicho_hora', bicho='$bicho' where idcadastro = '".$idcadastro."'";
  		...
  		<div id="wrapper">
            ...
            <div class="left">
                <div class="form_square_yellow" style="margin-top:10px; margin-left:5px;">
                    <b><?=$dias_de_vida?></b> dias ou <b><?=$horas_de_vida;?></b> horas de jogo com este bichinho
                </div>
          	</div>
            <div class="right">
            	<div class="clearbr"></div>
                ...
                <div class="form_square_blue">
                    ...
                    <div class="left">
                    	<div class="form_square_yellow">
                            <small>
                            Alimentação = A cada <b>2 minutos</b><br />
                            Doente = <b>10 minutos</b> sem alimentação
                            </small>
                        </div>
                    </div>
                    <div class="left">
                    	<div class="form_square_yellow">
                            ...
                            Doente = <b>10 minutos</b> sem brincar
                            </small>
                        </div>
                    </div>
                    <div class="left">
                    	<div class="form_square_yellow">
                            <small>
                            Banho = A cada <b>6 minutos</b><br />
                            Doente = <b>10 minutos</b> sem Banho
                            </small>
                        </div>
                    </div>
                    <div class="left">
                    	<div class="form_square_yellow">
                            <small>
                            <b>FALENCIA DO BICHINHO</b><br />
                            O bichinho falece com <b>15 minutos</b> doente
                            </small>
                        </div>
                    </div>
                    <div class="clear"></div>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','284','height','73','src','../../swf/bt/comer','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../swf/bt/comer' ); //end AC code
</script><noscript><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553533400" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="284" height="73">
  <param name="movie" value="../../swf/bt/comer.swf" />
  <param name="quality" value="high" />
  <embed src="../../swf/bt/comer.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="284" height="73"></embed>
							</object></noscript>
						</a>
                        <?
						}
                ...
                <div class="left">
                	<small><?=$Msg_Br?></small><br />
                        ...
                        <a href="?act=brincar">
                        	<!--INSERIR SWF-->
                       		<script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','287','height','71','src','../../swf/bt/brincar','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../swf/bt/brincar' ); //end AC code
</script><noscript><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553533400" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="287" height="71">
                              <param name="movie" value="../../swf/bt/brincar.swf" />
                              <param name="quality" value="high" />
                              <embed src="../../swf/bt/brincar.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="287" height="71"></embed>
                   	    	</object></noscript>
                        </a>
                        <?
						}
                ...
                <div class="left">
                	<small><?=$Msg_Ba?></small><br />
                        ...
                        <a href="?act=banho">
                       	<script type="text/javascript">
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','282','height','69','src','../../swf/bt/banho','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../swf/bt/banho' ); //end AC code
</script><noscript><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553533400" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0" width="282" height="69">
                              <param name="movie" value="../../swf/bt/banho.swf" />
                              <param name="quality" value="high" />
                              <embed src="../../swf/bt/banho.swf" quality="high" pluginspage="http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="282" height="69"></embed>
                   	    </object></noscript>
                        </a>
                        <?
						}
				...
				?>
                <div class="left">
                	<small>Escolha um novo bichinho</small><br />
                    <a href="?act=novo"><img src="../../imagens/bt/bt-novo-ativo.png" /></a>
                    <br />
                    Bichinho:<input name="bicho" type="radio" value="Panda" id="radiobutton" checked="checked" />
                    <label for="radiobutton"><span class="style6">Panda</span> 
                    <input name="bicho" type="radio" value="Panda" id="radiobutton" />
                    <label for="radiobutton">Ursa</span><span class="style9"> *</span>
                </div>
                <?
				}
				?>
            ...
            if($_SESSION['AnimaComer']=="on")
            {
          	?>
            	<div class="clearbr"></div>
            	<span class="style2">Seu bichinho já está satisfeito! Clique no Botão <a href="?act=parar" class="bt-red">Voltar</a></span>
                <div class="clearbr"></div>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','460','height','334','src','../../swf/acoes/fome','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../swf/acoes/fome' ); //end AC code
			...
			elseif($_SESSION['AnimaBrincar']=="on")
            {
          	?>
            	<div class="clearbr"></div>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','460','height','334','src','../../swf/acoes/brincar','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../swf/acoes/brincar' ); //end AC code
			...
			elseif($_SESSION['AnimaBanho']=="on")
            {
          	?>
            	<div class="clearbr"></div>
            	<span class="style2">Seu Bichinho <b>está Limpo</b>! Clique no Botão <a href="?act=parar" class="bt-red">Voltar</a></span>
                <div class="clearbr"></div>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','460','height','334','src','../../swf/acoes/banho','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../swf/acoes/banho' ); //end AC code
			...
			elseif($_SESSION['AnimaRemedio']=="on")
            {
          	?>
            	<div class="clearbr"></div>
            	<span class="style2">Seu Bichinho <b>está Recuperado</b>! Clique no Botão <a href="?act=parar" class="bt-red">Voltar</a></span>
                <div class="clearbr"></div>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','460','height','334','src','../../swf/acoes/remedio','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../swf/acoes/remedio' ); //end AC code
			...
			elseif($Bt_Co == "on" and $Bt_Br == "on" and $Bt_Ba == "on")
			{
			?>
           	  <script type="text/javascript">
