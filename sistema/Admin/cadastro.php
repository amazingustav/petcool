...
if($acao == 'cadastrar')
{
	...
	if($bicho == 0)
	{
		echo "Escolha seu bicho!";
		exit;
	}
	
	
	// faz consulta no banco para inserir os dados do usuario
	$sql = "insert into cadastro (login,senha,nome,email,bicho) 
	values ('$login','$senha','$nome','$email','$bicho')";
  		...
  		<div id="wrapper">
            ...
            <div class="form_square_white">
                ...
                <div class="left">
                    ...
                    <div class="clearbr"></div>
                    <input name="bicho" type="radio" value="1" />
                    <label for="radiobutton"> Panda
                    <input name="bicho" type="radio" value="2" />
                    <label for="radiobutton">Ursa
                    <div class="clearbr"></div>
         	</div>
            <div class="clearbr"></div>
            <div class="right">
