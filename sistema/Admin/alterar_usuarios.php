...
{	
	...
	$bicho = isset($_REQUEST['bicho'])?$_REQUEST['bicho']:"";
	// deleta o usuario
	$sqlAlt = "update cadastro set login='$login', senha='$senha', nome='$nome', email='$email', bicho='$bicho' where idcadastro = '".$id."'";
	...
	<div id="content">
  		<div id="wrapper">
            ...
            <div class="form_square_white">
                ...
                <!---BICHINHO---->
                <b>Bichinho</b> <span class="red">(*)</span>
                <div class="clearbr"></div>
                <input name="bicho" type="radio" value="1" <? if($linha['bicho']==1){echo"checked";}?> /> Panda
                <input name="bicho" type="radio" value="2" <? if($linha['bicho']==2){echo"checked";}?> /> Ursa
                <div class="clearbr"></div>
			</div>
            <div class="clearbr"></div>
            <div class="right">
